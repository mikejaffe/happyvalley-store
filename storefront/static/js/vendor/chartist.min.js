    ...
    (function (a, b) {
      ...
      function c(a, c, d, e, f) {
        a instanceof Element
          ? (this._node = a)
          : ((this._node = y.createElementNS(b.namespaces.svg, a)), 'svg' === a && this.attr({ 'xmlns:ct': b.namespaces.ct })),
          c && this.attr(c),
          d && this.addClass(d),
          ...
          function (j, k) {
            ...
            ;(l = h[k + 1] ? h[k + 1] - j : Math.max(this.axisLength - j, 30)),
              (b.isFalseyButZero(i[k]) && '' !== i[k]) ||
                ...
                g.showGrid &&
                  b.createGrid(j, k, this, this.gridOffset, this.chartRect[this.counterUnits.len](), a, [e.classNames.grid, e.classNames[this.units.dir]], f),
                g.showLabel &&
                  b.createLabel(
                    j,
                    l,
                    ...
                    m,
                    c,
                    [e.classNames.label, e.classNames[this.units.dir], 'start' === g.position ? e.classNames[g.position] : e.classNames.end],
                    d,
                    f
                  ))
          }.bind(this)
          ...
          (f =
            void 0 === a.axisY.type
              ? new b.AutoScaleAxis(
                  ...
                  c.normalized.series,
                  j,
                  b.extend({}, a.axisY, { high: b.isNumeric(a.high) ? a.high : a.axisY.high, low: b.isNumeric(a.low) ? a.low : a.axisY.low })
                )
