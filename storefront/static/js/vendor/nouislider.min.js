!(function () {
  ...
  function n(t, e, n, r, i, o, s, a, l, u, c, p) {
    ...
    return (
      ...
      !('number' != typeof p || !isFinite(p)) &&
        (t && 0 === parseFloat(p.toFixed(t)) && (p = 0),
        p < 0 && ((f = !0), (p = Math.abs(p))),
        t && ((o = Math.pow(10, t)), (p = (Math.round(p * o) / o).toFixed(t))),
        -1 !== (p = p.toString()).indexOf('.') && ((p = (t = p.split('.'))[0]), n && (c = n + t[1])),
        e && (p = h((p = h(p).match(/.{1,3}/g)).join(h(e)))),
        f && a && (d += a),
        r && (d += r),
        f && l && (d += l),
        (d = d + p + c),
  ...
  function r(t, e, n, r, i, o, s, a, l, u, c, p) {
    ...
    return (
      ...
      c && (p = c(p)),
      !(!p || 'string' != typeof p) &&
        (a && p.substring(0, a.length) === a && ((p = p.replace(a, '')), (f = !0)),
        r && p.substring(0, r.length) === r && (p = p.replace(r, '')),
        l && p.substring(0, l.length) === l && ((p = p.replace(l, '')), (f = !0)),
    ...
    'object' == typeof e &&
      ((e = (function (t) {
        ...
        for (e = 0; e < s.length; e += 1)
          void 0 === (r = t[(n = s[e])])
            ? (i[n] = 'negative' !== n || i.negativeBefore ? 'mark' === n && '.' !== i.thousand && '.' : '-')
            : 'decimals' === n
            ? 0 < r && r < 8 && (i[n] = r)
            : 'encoder' === n || 'decoder' === n || 'edit' === n || 'undo' === n
            ? 'function' == typeof r && (i[n] = r)
            : 'string' == typeof r && (i[n] = r)
  ...
  (function (t) {
    ...
    function $(e) {
      var n = { margin: 0, limit: 0, padding: 0, animate: !0, animationDuration: 300, format: l },
        r = {
          step: { r: !1, t: u },
          start: { r: !0, t: h },
          connect: { r: !0, t: b },
    ...
    function O(t, f, o) {
      ...
      function y(r, i, o) {
        ...
        function p(t, e, n) {
          return (
            'class="' +
            ((r = n[1]), (o = (i = e) === f.cssClasses.value), (s = o ? a : l), i + ' ' + (o ? u : c)[f.ort] + ' ' + s[r]) +
            '" style="' +
            f.style +
            ': ' +
            t +
        ...
        return (
          I(t, f.cssClasses.pips),
          I(t, 0 === f.ort ? f.cssClasses.pipsHorizontal : f.cssClasses.pipsVertical),
          Object.keys(r).forEach(function (t) {
            var e, n
            ;((n = r[(e = t)])[1] = n[1] && i ? i(n[0], n[1]) : n[1]),
              (s += '<div ' + p(e, f.cssClasses.marker, n) + '></div>'),
              n[1] && (s += '<div ' + p(e, f.cssClasses.value, n) + '>' + o.to(n[0]) + '</div>')
          }),
          (t.innerHTML = s),
          t
        )
      ...
      function E(r, e, i, o) {
        var n = function (t) {
            return (
              ...
              ((e = S),
              (n = f.cssClasses.tap),
              (e.classList ? !e.classList.contains(n) : !new RegExp('\\b' + n + '\\b').test(e.className)) &&
                !!(t = (function (t, e) {
                  t.preventDefault()
                  var n,
                    r,
                ...
                !(r === p.start && void 0 !== t.buttons && 1 < t.buttons) &&
                (!o.hover || !t.buttons) &&
                ((t.calcPoint = t.points[f.ort]), void i(t, o)))
            )
            var e, n
          },
          s = []
          ...
          s =
            (100 *
              (t -
                ...
                n ? r.top + o.y - i.clientTop : r.left + o.x - i.clientLeft))) /
            w()
      ...
      function V(t) {
        ...
        var r,
          ...
          n =
            ...
            o)
        if (!1 === n) return !1
        f.events.snap || X(S, f.cssClasses.tap, f.animationDuration),
          z(n, e, !0, !0),
          j(),
          U('slide', n, !0),
          U('set', n, !0),
          U('change', n, !0),
          U('update', n, !0),
          f.events.snap && O(t, { handleNumbers: [n] })
      }
      function A(t) {
        var e = C(t.calcPoint),
          n = x.getStep(e),
      ...
      function L(t, e, n, r, i) {
        var o
        return (
          1 < l.length && (r && 0 < e && (n = Math.max(n, t[e - 1] + f.margin)), i && e < l.length - 1 && (n = Math.min(n, t[e + 1] - f.margin))),
          1 < l.length && f.limit && (r && 0 < e && (n = Math.min(n, t[e - 1] + f.limit)), i && e < l.length - 1 && (n = Math.max(n, t[e + 1] - f.limit))),
          f.padding && (0 === e && (n = Math.max(n, f.padding)), e === l.length - 1 && (n = Math.min(n, 100 - f.padding))),
          (n = x.getStep(n)),
          (o = n),
          (n = Math.max(Math.min(o, 100), 0)) !== t[e] && n
        )
      }
      function F(t) {
        return t + '%'
      ...
      function T(t, e) {
        ...
        ;(e = void 0 === e || !!e),
          n.forEach(D),
          f.animate && !r && X(S, f.cssClasses.tap, f.animationDuration),
          h.forEach(function (t) {
            z(t, d[t], !0, !1)
          }),
          j(),
      ...
      return (
        I((e = S), f.cssClasses.target),
        0 === f.dir ? I(e, f.cssClasses.ltr) : I(e, f.cssClasses.rtl),
        0 === f.ort ? I(e, f.cssClasses.horizontal) : I(e, f.cssClasses.vertical),
        (a = B(e, f.cssClasses.base)),
        (function (t, e) {
          ;(l = []), (s = []).push(b(e, t[0]))
          for (var n = 0; n < f.handles; n++)
            l.push(
              ((r = n),
              (o = void 0),
              (i = B(e, f.cssClasses.origin)),
              B((o = B(i, f.cssClasses.handle)), f.cssClasses.handleTouchArea),
              o.setAttribute('data-handle', r),
              0 === r ? I(o, f.cssClasses.handleLower) : r === f.handles - 1 && I(o, f.cssClasses.handleUpper),
              i)
            ),
              (h[n] = n),
              s.push(b(e, t[n + 1]))
        ...
        (u = {
          ...
          updateOptions: function (e, t) {
            ...
            r.forEach(function (t) {
              ...
              (i.spectrum.direction = x.direction),
              (x = i.spectrum),
              (f.margin = i.margin),
              (f.limit = i.limit),
              (f.padding = i.padding),
          ...
          s.forEach(function (t, e) {
            if (!1 !== t && 0 !== e && e !== s.length - 1) {
              var n = l[e - 1],
                r = l[e],
                i = [t]
              I(t, f.cssClasses.draggable),
                c.fixed && (i.push(n.children[0]), i.push(r.children[0])),
