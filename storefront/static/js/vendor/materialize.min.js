    ...
    k(['Width', 'Height'], function (e) {
      ...
      ;(y[t] = function () {
        ...
        (y['outer' + e] = function (t) {
          return (
            this[0]['offset' + e] + (t ? F(this, 'margin' + ('Width' === e ? 'Left' : 'Top')) + F(this, 'margin' + ('Width' === e ? 'Right' : 'Bottom')) : 0)
          )
        })
    }),
    y.extend({
...
!(function (t) {
  ...
  'function' == typeof define && define.amd
    ...
    : 'undefined' == typeof exports ||
      exports.nodeType ||
      ('undefined' != typeof module && !module.nodeType && module.exports && (exports = module.exports = M), (exports.default = M)),
  (M.version = '1.0.0'),
      ...
      ;(n <= a || !e) && (k.began || ((k.began = !0), p('begin')), p('run')),
        ...
        e <= t &&
          (k.remaining
            ...
            : (k.pause(), k.completed || ((k.completed = !0), p('complete'), 'Promise' in window && (_(), (y = d())))),
          (g = 0))
    }
    t = void 0 === t ? {} : t
    var f,
                  ...
                  if (
                    ...
                    l.top ||
                      (l.bottom
                        ? (h = 'bottom')
                        : ((this.isScrollable = !0),
                          l.spaceOnTop > l.spaceOnBottom ? ((h = 'bottom'), (i += l.spaceOnTop), (o -= l.spaceOnTop)) : (i += l.spaceOnBottom))),
                    !l[d])
                  ) {
                ...
                value: function () {
                  ...
                  ;(this.dropdownEl.style.left = e.x + 'px'),
                    ...
                    (this.dropdownEl.style.transformOrigin =
                      ('left' === e.horizontalAlignment ? '0' : '100%') + ' ' + ('top' === e.verticalAlignment ? '0' : '100%'))
                },
              },
              {
                key: 'open',
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.el.classList.contains('bottom-sheet')
                    ...
                    : s.extend(e, { top: [this.options.endingTop, this.options.startingTop], opacity: 0, scaleX: 0.8, scaleY: 0.8 }),
                    i(e)
                },
              },
              {
                ...
                value: function () {
                  if (this.isOpen)
                    return (
                      ...
                      this.options.dismissible &&
                        (document.removeEventListener('keydown', this._handleKeydownBound), document.removeEventListener('focus', this._handleFocusBound, !0)),
                      i.remove(this.el),
                      i.remove(this.$overlay[0]),
                      this._animateOut(),
                      this
              ...
              },
              {
                ...
                value: function () {
                  this.$img[0].removeEventListener('load', this._handleImageLoadBound),
                    0 === n._parallaxes.length &&
                      (window.removeEventListener('scroll', n._handleScrollThrottled), window.removeEventListener('resize', n._handleWindowResizeThrottled))
                },
              },
              {
                key: '_setupStyles',
              ...
              },
              {
                ...
                value: function () {
                  var t = 0 < this.$el.height() ? this.el.parentNode.offsetHeight : 500,
                    ...
                    a = e * ((s + o - n) / (t + o))
                  this._enabled
                    ? s < i && n < s + o && (this.$img[0].style.transform = 'translate3D(-50%, ' + a + 'px, 0)')
                    : (this.$img[0].style.transform = '')
                },
              },
            ],
          ...
          _createClass(
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  e.remove(this.tooltipEl),
                    e({ targets: this.tooltipEl, opacity: 0, translateX: 0, translateY: 0, duration: this.options.outDuration, easing: 'easeOutCubic' })
                },
              },
              {
                key: '_handleMouseEnter',
                ...
                value: function () {
                  if (s._draggedToast) {
                    ...
                    Math.abs(e) > i || 1 < t.velocityX
                      ...
                      : ((t.el.style.transition = 'transform .2s, opacity .2s'), (t.el.style.transform = ''), (t.el.style.opacity = '')),
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  this.isOpen &&
                    this.isDragged &&
                    (0.8 < this.percentOpen ? this._animateIn() : this.close(), (this.isDragged = !1), (this._verticallyScrolling = !1))
                },
              },
              {
                ...
                value: function () {
                  ;(c._visibleElements = c._visibleElements.filter(function (t) {
                    ...
                    ? (o(this.options.getActiveElement(c._visibleElements[0].attr('id'))).removeClass(this.options.activeClass),
                      c._visibleElements[0][0].M_ScrollSpy && this.id < c._visibleElements[0][0].M_ScrollSpy.id
              ...
              },
              {
                ...
                value: function () {
                  this.$el.hasClass('fullscreen') ||
                    (this.options.indicators ? this.$el.css('height', this.options.height + 40 + 'px') : this.$el.css('height', this.options.height + 'px'),
            ...
            [
                ...
                value: function (t) {
                  if (this.isOpen || t) {
                    ...
                    for (var l = 0; l < 1; l++)
                      this._renderDateDisplay(),
                        (r +=
                          this.renderTitle(this, l, this.calendars[l].year, this.calendars[l].month, this.calendars[0].year, e) +
              ...
              },
              {
                ...
                value: function (t) {
                  var e = void 0
                  t.firedBy !== this &&
                    ((e = this.options.parse ? this.options.parse(this.el.value, this.options.format) : new Date(Date.parse(this.el.value))),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    (this.options.twelveHour &&
                      void 0 !== t[1] &&
                      (0 < t[1].toUpperCase().indexOf('AM') ? (this.amOrPm = 'AM') : (this.amOrPm = 'PM'), (t[1] = t[1].replace('AM', '').replace('PM', ''))),
                    'now' === t[0])
                  ) {
              ...
              },
              {
                ...
                value: function () {
                  ;(this.counterEl = document.createElement('span')),
                    s(this.counterEl).addClass('character-counter').css({ float: 'right', 'font-size': '12px', height: 1 }),
      ...
      t = (function (t) {
        function i(t, e) {
          ...
          return (
            ...
            n.options.fullWidth &&
              ((n.options.dist = 0), n._setCarouselHeight(), n.showIndicators && n.$el.find('.carousel-fixed-item').addClass('with-indicators')),
            ...
            [
                ...
                value: function (t) {
                  if (this.pressed)
                    return (
                      ...
                      this.noWrap &&
                        (this.target >= this.dim * (this.count - 1) ? (this.target = this.dim * (this.count - 1)) : this.target < 0 && (this.target = 0)),
                  ...
                  for (a = 1; a <= i; ++a) {
                    if (
                      (this.options.fullWidth
                        ...
                        : ((h = this.options.dist * (2 * a + o * s)), (d = 1 - p * (2 * a + o * s))),
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  this.noWrap ||
                    (i < 0 ? Math.abs(i + this.count) < Math.abs(i) && (i += this.count) : 0 < i && Math.abs(i - this.count) < i && (i -= this.count)),
              ...
              },
              {
                ...
                value: function () {
                  ;(this.wrapper = this.$el.parent()[0]),
                    ...
                    this.contentEl ||
                      ((this.contentEl = document.createElement('div')), this.contentEl.classList.add('tap-target-content'), this.$el.append(this.contentEl)),
                    this.waveEl ||
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  //   this._setValueToInput()
                  // var t = d(
                  //   '<svg viewBox="0 0 30 18" class="select__StyledChevronIcon-sc-8463nz-0 hsynYG MuiSelect-icon MuiSelect-iconOutlined" height="7px" width="12px"><path clip-rule="evenodd" d="M26.137.702a2.175 2.175 0 013.2 0c.873.91.886 2.4.027 3.327l-.027.029-12.74 13.25a2.18 2.18 0 01-3.187 0L.663 4.058C-.21 3.147-.222 1.658.635.73L.663.7a2.175 2.175 0 013.186 0L15 11.573z" fill-rule="evenodd"></path></svg>'
                  // )
                  ...
                  //     if (
                  //       e.length &&
                  //       ((M.keyDown = !0), (n.dropdown.focusedIndex = e.index()), n.dropdown._focusFocusedItem(), (M.keyDown = !1), n.dropdown.isScrollable)
                  //     ) {
                ...
                value: function () {
                  if (!this._mousedown) {
                    ...
                    s(this.thumb).hasClass('active') &&
                      (e.remove(this.thumb), e({ targets: this.thumb, height: 0, width: 0, top: 10, easing: 'easeOutQuad', marginLeft: t, duration: 100 })),
